  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="flex flex-col md:flex-row flex-1">
        ...
        <div
          className={`fixed md:static inset-y-0 left-0 z-20 md:z-auto transform md:transform-none transition-transform duration-200 ease-in-out h-full md:flex-shrink-0
            ${
              sidebarOpen
                ? "translate-x-0"
